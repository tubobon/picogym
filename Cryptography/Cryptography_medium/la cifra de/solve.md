# la cifra de
`nc jupiter.challenges.picoctf.org 58295`に接続後、以下の暗号が与えられる。
...
これはビジュネル暗号であるが、鍵が分からないので鍵を推定して解読してくれるサイトにかけた。https://www.guballa.de/vigenere-solver

これで復号が完了したため、flagを得ることができる。\
